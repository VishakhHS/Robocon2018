            ...
            if ((digital_stop_1 == 1) && (flag == 1))
            {
...

              {
               ...
               // Serial.println(pwm2);
                ...
                if (n3 == 2)
                {
                  Serial.println("tz2_enter_junction");
                      ...
                      while (flagtz1y == 3)
                      {
                        ...
                        if ((laser_interrupt_2 == 1) && (flagtz1y == 3))
                        {
                          ...
                          while (flagtz1y == 3)
                          {
                            ...
                            y = digitalRead(49);
                            z = digitalRead(51);
                            Serial.println("tz2_enter_reverse");
                            //  flagtz1y = 2;
                            digitalWrite(dir3, HIGH);
                            digitalWrite(dir4, HIGH);
                            analogWrite(pwm3, 110);
                              ...
                              while ((nx == 2) && (flagtz1y == 4) )
                              {
                                ...
                                if (digital_stop_2 == 1)
                                {
                                  ...
                                  while (flagsh == 1)
                                  {
                                    ...
                                    Wall_Follow(Backward);
                                    junctionCount4 = digitalRead(jPulse4);
                                    if ((junctionCount4 == 1) && (flagtz1y == 5))
                                    {
                                      flagtz1y = 6;
                                      while (flagtz1y == 6)
                                      {
